...
import { getFirestore, collection, addDoc, getDocs, query, where, onSnapshot, doc, updateDoc, deleteDoc, setDoc, getDoc, writeBatch, limit, getCountFromServer } from "https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";
...
export class SaasService {
    ...
    async updateOrderStatus(id,s) { await updateDoc(doc(this.db,"orders",id),{status:s}); }
}